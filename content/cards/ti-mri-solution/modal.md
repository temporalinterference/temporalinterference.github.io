...
The TI protocol is conveniently operated from the PC in the MRI control room, where the TIBS-R is also located. The standard Electrode Connection Box (ECB) is replaced with an fMRI-compatible version supplied by IT’IS.
...
### MRI Filters for TIBS-R

|    |            |
|:-----------|:------------|
|Number of Stimulation Channels|4 (8 electrodes) |
|Electrode Connector Type|Touch-Proof 1.5 mm female |
...
|RF Attenuation|XX dB differential / common mode / shield (STILL TO BE ADDED) |
